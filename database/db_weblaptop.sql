...
('QL', 'Quản lý', 'Là người quản lý bán hàng');
...
INSERT INTO `mausacsanpham` (`MASP`, `MAMAU`) VALUES
(1, 3),
(2, 5),
(3, 4),
(4, 3),
...
--
ALTER TABLE `monhang`
  ADD KEY `FK_RELATIONSHIP_6` (`MASP`),
  ADD KEY `FK_RELATIONSHIP_7` (`MADH`);
...
ALTER TABLE `nguoidung`
  ...
  ADD KEY `FK_RELATIONSHIP_4` (`MAQUYEN`);
...
--
ALTER TABLE `hinhanh`
  MODIFY `MAIMG` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `hinhanh`
  ADD CONSTRAINT `hinhanh_ibfk_1` FOREIGN KEY (`MASP`) REFERENCES `hinhanh` (`MAIMG`);

--
-- Constraints for table `mausacsanpham`
--
ALTER TABLE `mausacsanpham`
  ADD CONSTRAINT `mausacsanpham_ibfk_1` FOREIGN KEY (`MASP`) REFERENCES `sanpham` (`MASP`),
  ADD CONSTRAINT `mausacsanpham_ibfk_2` FOREIGN KEY (`MAMAU`) REFERENCES `mausac` (`MAMAU`);
