...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2021 at 02:46 PM
...
('H1', 1, '1_asus-vivobook.jpg'),
('H10', 2, '10_apple-macbook-pro.JPG'),
('H2', 3, '2_lenovo-ideapad.jpg'),
('H3', 4, '3_hp-15s.jpg'),
('H4', 5, '4_acer-aspire-5.jpg'),
('H5', 6, '5_dell-g3.JPG'),
('H6', 7, '6_acer-aspire-7.JPG'),
('H7', 8, '7_lg-gram-15-i5.JPG'),
('H8', 9, '8_huawei-matebook.JPG'),
('H9', 10, '9_msi-gl65.JPG');
...
(1, 'HT-VP', NULL, 'ASUS', 'Asus VivoBook X415EA', 'Laptop Asus VivoBook X415EA i5 (EK033T) đi theo xu hướng thiết kế hiện đại, tối giản, chú trọng vào độ linh hoạt và cơ động để người dùng dễ di chuyển hằng ngày. Chiếc máy này sở hữu bộ vi xử lí gen 11 đến từ nhà Intel cho hiệu suất làm việc cao, ổn định. \r\nThiết kế tối giản, gọn gàng với trọng lượng chỉ 1.55 kg.', 8, 'Intel Core i5 Tiger Lake, 1135G7, 2.40 GHz', '14 inch', 1599, 10, '2020-05-11'),
