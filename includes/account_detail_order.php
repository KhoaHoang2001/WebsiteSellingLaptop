...
<tbody id="trangThaiDonHang_tblBody">
  ...
  ?>
      <tr>
        <td><img src="./admin/product_images/<?php echo $hinh ?>" class="trangThaiDonHang_product"></td>
        <td>
  ...
  <tr>
    <td colspan="4">
      <div class="trangThaiDonHang_product--intro">
        <a class="btn btn-danger btn-submit btn-sm" style="margin: 0" href="./account.php#TTDH">Trở về</a>
      </div>
    </td>
  </tr>
</tbody>