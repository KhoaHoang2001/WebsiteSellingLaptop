...
<div class="view_product_box">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <table width="100%">
            ...
            <?php
            $sql_all_staff = "SELECT * FROM NGUOIDUNG,NHANVIEN,CHUCVU,LUONGTHANG WHERE NGUOIDUNG.TAIKHOAN = NHANVIEN.TAIKHOAN AND NHANVIEN.MANV = LUONGTHANG.MANV AND NGUOIDUNG.CHUCVU = CHUCVU.MACV";
